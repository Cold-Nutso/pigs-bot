...
const pigNames = [ "Mr. Pig", "Piggie Smalls",  "Piggle Rick", "Swiney Todd", "The Pig Lebowski", "Model 01-NK", "Boarimir", "Piggy Azalea", "Cyril Piggis" ];
...
const startGame = (playerName, opponentName) => {
    ...
    !playerStats[`${playerName}`] ? addPlayer(playerName) : "player found";
    !playerStats[`${opponentName}`] ? addPlayer(opponentName) : "player found";
